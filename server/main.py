...
class PredictRequest(BaseModel):
    # Accept arbitrary fields — validation is light
    data: dict
...
async def train(csv_file: UploadFile = File(...)):
    ...
    try:
        ...
        # Defer heavy imports until runtime so the app can start even when
        # requirements haven't been installed yet. Handlers will return
